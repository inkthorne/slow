...
fn test_insert_and_get_best_route() {
    ...
    route_table.insert_route(junction_id.clone(), addr1, 5, 10.0);
    route_table.insert_route(junction_id.clone(), addr2, 3, 5.0);

    let best_route = route_table.get_best_route(junction_id.clone());
...
fn test_remove_route() {
    ...
    route_table.insert_route(junction_id.clone(), addr, 5, 10.0);
    let removed_route = route_table.remove(junction_id.clone());
